...
No inicio de uma cena furtiva todos rodam um de 100 e adicionam seus bonus que são modificados. Esse será o seu nível de "**Sombra**" e não pode passar de 100

A cada ação que você fizer você vai gastar(ou ganhar) esses pontos conforme a cena vai passando. Ações mais difíceis ou muito barulhentas abaixam mais dessa barra 
## Alterando Bonus
...
#### Esconder
Você gasta sua rodada se escondendo em alguma coisa (parede, caixa, ventilação) então roda roda 1d20+bonus+qualidade do esconderijo
...
Padrão
#### Bem Iluminado
Todos os testes de percepção sofrem uma vantagem de +2. além disso todas as ações de visão gastam +1 e você perde 1d6 ao recuperar Sombra (Você não pode recuperar negativo nem recuperar 0) 
#### Muito Bem Iluminado
...
#### Em Alerta
Eles sabem que vocês estão ai e vão fazer de tudo para encontrar. Todos os testes de percepção são multiplicados por +1x