...
Acesso: A facilidade de alcançar o item no combate
 **Rápido:** Itens de fácil acesso como armas, granadas e utilitários definidos por coldres, bainhas e bandoleiras. Um item em um slot de Acesso rápido pode ser sacado como ação de movimento
...
*"Ele Aguenta Carregar Tudo, Mas, Não Tem Onde Colocar"*
## Penalidades
Peso: recebe desvantagem em certas perícias e corta o movimento em combate pela metade

Carga: pode improvisar espaços porém a cada carga improvisada você transforma um Acesso rápido em um Acesso normal