...
O Background é tudo que veio antes da primeira cena. São as experiências, perdas, conquistas e escolhas que te moldaram, ela é uma fonte constante de motivação, conflitos e objetivos.

Uma boa backstory não precisa ser longa nem complexa, ela que deve responder por que seu personagem está aqui, o que quer e o que ele teme. É nela que nascem as decisões que o seu personagem tomaria dependo da situação.

Mas não se preocupe, criar uma backstory pode ser complicada, especialmente se você não é um jogador recorrente. Como base, você sempre pode se apoiar em um Background de referência para guiar suas ideias. E, caso esteja sem inspiração, ou se a sessão for apenas um teste ou one-shot, onde você não pretende se aprofundar tanto no personagem, optar apenas por um Background, sem desenvolver uma história completa, é totalmente válido.

Além de ajudar a definir sua Lore, os Backgrounds também concedem perícias, atributos e equipamentos iniciais. Para mais detalhes sobre como cada um funciona, consulte a seção a seguir “Background”.  
## Background
### **Antigo Scavenger**
...
### Aprendiz
Você teve uma figura que fez parte do prisma e dessa forma foi infl