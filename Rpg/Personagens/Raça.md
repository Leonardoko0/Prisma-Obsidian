...
As raças representam muito mais do que aparência ou habilidades, elas definem a forma como seu personagem existe no mundo. Cada raça carrega uma história, culturas, conflitos e estereótipos. Suas características influenciam suas capacidades físicas ou mentais, e também como outros o percebem.

Além disso, as raças concedem benefícios específicos, como habilidades únicas, aumentos em atributos, treinamento em determinados tipos de armas e a definição dos idiomas que o personagem conhece.
## **Humanos**

### Habilidade: Jack Of All Trades 
...
Escolha entre ter mais um Trait de sua escolha ou 3 Perícias treinadas a a mais 
### Aumento Em Atributo
Escolha um atributo para receber um +1 na contagem e outro para receber +2
### Treinamento Em Armamento Humano
Escolha 1 tipo de munição de pólvora para ser treinado ou um tipo de arma branca para ser treinado
### Idiomas
...
Alvo: Você
Usos: Sua proficiência dividida por 2
Duração: Cena

Você volta sua mente ao Plano Etéreo, buscando a marca que ecoa além do véu da realidade. Quando a encontra, o instinto fala mais alto e você responde. Com um um único gesto, o véu é rasgado, abrindo um fluxo de energia entre os planos.

**"E Então... Você Abre Suas Asas"**
...
## **Aeolus**
### Habilidade: Vento Leve
Conjuração: Reação 
Alvo: Você
Usos: Sua proficiência
Duração: Até o fim da queda 

Uma brisa suave e constante envolve seu corpo, fluindo pela sua pele como se sempre tivesse feito parte de você. Em um instante, seu peso parece desaparecer, e o ar passa a sustentá-lo com delicadeza.
...
### Habilidade: Marcas
Conjuração: Ação
Alvo: (Oighear, Stoirm: Você) (Fearg: 1 Ser/Alcance longo)
Usos: (Oighear, Stoirm: Proficiência dividido por 2) (Fearg: Proficiência)
Duração: (Oighear, Stoirm: Cena) (Fearg: instantâneo)
...
Enquanto ativo, você pode criar extensões do seu corpo em gelo como lâminas, placas protetivas e equipamentos auxiliares. (Pode gerar 2 extensões ao mesmo tempo e +1 nos níveis 7 e 15)
...
- Duração: Cena 
- Alvo: Você
Você abre todos os seus olhos ganhando uma visão panorâmica impressionante. Ao usar você fica imune a estar desprevenido pela visão e recebe +2 em testes e salvaguardas de sentido que utilizem visão.
...
Você é uma criatura feita pra nadar em água e em outros líquidos e possui um corpo adaptado para tanto ambientes aquáticos quanto para ambientes de terra firme. Você possui a capacidade de respirar em líquidos com oxigênio além disso você tem sua visão de baixo da água e movimento nadando dobrados 
### Aumento Em Atributo
