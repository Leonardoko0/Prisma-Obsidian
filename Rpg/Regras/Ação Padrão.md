...
### Avançar
Ataque o alvo com sua arma corpo a corpo. Em seguida, empurre-o um tile para trás e mova-se para o tile que ele ocupava. Dependendo da arma custa estâmina 
### Investida
...
- **Asfixiar:** Faça um novo teste de Força contra o Salvaguarda de Fortitude (Con) do alvo. Se for bem-sucedido, você aplica 1 acerto. Além disso, para cada 5 pontos de diferença entre os resultados a seu favor, aplique 1 acerto adicional.
  Quando o alvo acumular uma quantidade de acertos igual a 2 +(Con), ele fica inconsciente.
...
- Fratura Superficial (Perna): Perde 3m de movimento, além disso não pode realizar ações de corrida 
#### Pé
- Modificador: -3
