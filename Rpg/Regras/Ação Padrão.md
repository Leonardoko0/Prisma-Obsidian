...
- Asfixiar: rode novamente um teste de (For) dessa vez contra o Salvaguarda de Fortitude (Con) do alvo, se passar recebe um acerto além disso a cada para cada 5 pontos adicionais na diferença dos testes você recebe um acerto extra. ao acumular uma quantidade = 1+(Con) você deixa o alvo inconciente
### Derrubar
